...
export default (props) => {
	...
	return (
		<div>
			...
			<Dialog title="Disregard Tattoo Selection?" open={cancelling} onAccept={onCancel} onDecline={() => setCancelling(false)} acceptLang="Yeah, I Don't Want to Change" declineLang="Wait, Let Me Finish">
				<p>All changes will be discarded, are you sure you want to continue?</p>
			</Dialog>
			<Dialog title="Confirm Tattoo Selection?" open={saving} onAccept={onSave} onDecline={() => setSaving(false)} acceptLang="Ink Me Up" declineLang="Wait, Let Me Finish">
				{admin ? (
